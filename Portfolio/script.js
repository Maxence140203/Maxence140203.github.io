  ...
  if(e.key === 'Enter'){
    if(result === ""){
      ...
      if (y === -1){
        ...
        if(result === "maxence poizat" || result === "cd maxence poizat" || result === "cd maxence\\ poizat/" || result === "maxence\\ poizat/" || result === "cd"){
          y ++;
      ...
      if (y === -1){
        terminal = document.getElementById("terminal");
        terminal.insertAdjacentHTML("beforeend", `<p class="commande" id="answer${i}">Maxence Poizat:~$:</p><input type="text" autofocus class="input themeinput" id="input${i}" tabindex="-1">`);
      } else if (y === 1){
        terminal = document.getElementById("terminal");
        terminal.insertAdjacentHTML("beforeend", `<p class="commande" id="answer${i}">Maxence Poizat:~/portfolio/themes$:</p><input type="text" autofocus class="input themeinput" id="input${i}" tabindex="-1">`);
      } else {
        terminal = document.getElementById("terminal");
        terminal.insertAdjacentHTML("beforeend", `<p class="commande" id="answer${i}">Maxence Poizat:~/portfolio$</p><input type="text" autofocus class="input" id="input${i}" tabindex="-1">`);
      }
      document.getElementById(`input${i}`).focus();
